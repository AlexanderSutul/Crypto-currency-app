...
const getUrlByCriptoName = cryptoName => {
...
const Main = () => {
  ...
  const getNewCrypto = async cryptoName => {
    ...
    const apiLink = getUrlByCriptoName(cryptoName)
    ...
    <Container>
      ...
      <Grid>
        <form className={classes.root} noValidate autoComplete="off" onSubmit={handleSubmit}>
          <TextField variant={'outlined'} id="standard-basic" label="Start typing here" value={inputText} onChange={(e) => setInputText(e.target.value)} />
          <br />
